      ...
      <footer className="bg-white border-t border-gray-200 pt-10 pb-6">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-5 gap-8 mb-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-xs text-gray-400 mb-4">
                A product by <span className="text-gray-500 font-medium">Elixa Software Private Limited</span>
              </p>
              <div className="flex gap-2">
                <a href="#" className="h-8 w-8 rounded-lg bg-gray-100 hover:bg-[#D4DE95]/40 text-gray-500 hover:text-[#3D4127] flex items-center justify-center transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/company#about" className="text-gray-500 hover:text-[#3D4127] transition-colors">About Elixa</Link></li>
                <li><Link href="/company#blog" className="text-gray-500 hover:text-[#3D4127] transition-colors">Blog</Link></li>
                <li><Link href="/company#careers" className="text-gray-500 hover:text-[#3D4127] transition-colors">Careers</Link></li>
                <li><Link href="/company#press" className="text-gray-500 hover:text-[#3D4127] transition-colors">Press Kit</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/support#help-center" className="text-gray-500 hover:text-[#3D4127] transition-colors">Help Center</Link></li>
                <li><Link href="/support#contact" className="text-gray-500 hover:text-[#3D4127] transition-colors">Contact Us</Link></li>
          ...
          <div className="border-t border-gray-100 pt-5 flex flex-col md:flex-row justify-between items-center gap-3">
            <p className="text-xs text-gray-400">&copy; 2026 Business Pro Hub. All rights reserved.</p>
